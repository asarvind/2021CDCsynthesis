...
unstable for $\ub\geq 2.0888$.  This is because $\R{0.4}\R{2.088} =
A_r\exp\rb{0.4A_c}A_r\exp\rb{1.888 A_c}A_r\exp\rb{0.2 A_c}$ has
eigenvalues outside unit complex circle.  Instead, if we take $F_p
