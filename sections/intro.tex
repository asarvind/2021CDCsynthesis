Sampled data systems are prone to loss of information which can result
in subsequent inactuation and instability of the system.  In this
case, we may expect to stabilize the system by applying feedback based
...
previous sample becomes challenging.  For instance, the expected
...
available is uncertain (\emph{this is explained in
  Example~\ref{eg:counterintuitive}}).  There can be other historical
feedbacks which may stabilize the system more robustly, i.e., for
