Sampled data systems are systems where the feedback input is
periodically sampled based on information received about the state of
the system, typically over a communication network.  They can be used
to control distributed components of a system by communicating state information.
But communication networks are prone to loss of
information, which can result in subsequent inactuation and
instability of a sampled data system.  In the case of information
loss, we may expect to stabilize the system by applying feedback based
...
information is missing and also the sampling time is uncertain.  To this
