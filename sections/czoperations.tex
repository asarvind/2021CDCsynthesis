...
\end{definition}
%
The following theorem illustrates the relation between the eigenstructure of the system and finding contractive complex zonotopes.
%
...
\end{align*}
%
The following relation is a sufficient condition for checking the required inclusion which is proved later in Lemma~\ref{lem:inclusion}.  The following Lemma~\ref{lem:inclusion} is an extension of the inclusion checking between two complex zonotopes proved in~\cite{adimoolam2018calculus} (see Theorem 2.3.8).
%
