...
%
\begin{proof}
Let us assume that  $ \cz{Q\errplus \Upsilon}{e\errplus \rho}{r}\order \cz{P}{c}{s}$ is true.  Hence, there exist matrices $X,\Delta$ and complex vectors $y,\rho$ such that all the equations~(\ref{eqn:inc1})-(\ref{eqn:inc2}) are true.
%
% \begin{align*}
